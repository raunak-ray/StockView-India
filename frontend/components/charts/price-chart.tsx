...
function palette(dark: boolean) {
  return dark
    ? {
        ...
        support: "#34d399",
        resistance: "#ef5350",
        volUp: "rgba(52,211,153,0.4)",
        volDown: "rgba(239,83,80,0.4)",
        macdUp: "rgba(52,211,153,0.5)",
        macdDown: "rgba(239,83,80,0.5)",
        eq: "#d29922",
        bullFill: "rgba(52,211,153,0.16)",
        bullFillMuted: "rgba(52,211,153,0.06)",
    ...
    : {
        ...
        support: "#047857",
        resistance: "#dc2626",
        volUp: "rgba(4,120,87,0.35)",
        volDown: "rgba(220,38,38,0.35)",
        macdUp: "rgba(4,120,87,0.45)",
        macdDown: "rgba(220,38,38,0.45)",
        eq: "#b45309",
        bullFill: "rgba(4,120,87,0.14)",
        bullFillMuted: "rgba(4,120,87,0.05)",
